...
let index = 0 ;
let poster_song_player = document.getElementById('song_player_poster');
let musicDownloads = document.getElementById('music_downloads');
...
Array.from(document.getElementsByClassName('playlistPlay')).forEach((e) =>{
    e.addEventListener('click', (el) =>{
        ...
        music.play();
        poster_song_player.src = `img/${index}.jpg`;
        music.play();
        masterPlay.classList.add('bi-pause-fill');
        masterPlay.classList.remove('bi-play-fill');
        musicDownloads.href = `audio/${index}.mp3`;
        ...
        songTitles.forEach(elss => {
            ...
            musicDownloads.setAttribute('download' , songName);
        });
